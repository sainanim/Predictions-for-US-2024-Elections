...
state_vote_for_biden <- read.csv(here("output", "state_vote_for_biden.csv"))

age_vote_for_biden <- read.csv(here("output", "age_vote_for_biden.csv"))

sex_vote_for_biden <- read.csv(here("output", "sex_vote_for_biden.csv"))

general_data <- read.csv(here("output", "general_vote_for_biden.csv"))
