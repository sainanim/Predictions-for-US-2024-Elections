...
date: today
date-format: long
abstract: "This study investigates the dynamics of voting behaviour using data from the American Community Survey(ACS)
2022 sample and predicting what the results would be for the 2024 Election.

 We look at the correlation between voting preferences and demographic, socioeconomic, and geographic factors,
 such as age, family income, education, state of residency, and sex.
...
up the dataset and consider how important they are to comprehending voting patterns and electoral results for the 2024 election
using this 20022 survey data.
